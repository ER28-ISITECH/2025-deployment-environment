...
import { TaskTestingModule } from "./task.testing.module"; // Import the new testing module

describe("TaskController (Integration/E2E)", () => {
  let app: INestApplication;
  let mockTaskRepository: MockTaskRepository;

  beforeAll(async () => {
    const moduleFixture: TestingModule = await Test.createTestingModule({
      imports: [TaskTestingModule], // Use the TaskTestingModule
    })
      // No need to override TaskRepository here explicitly, as TaskTestingModule already does it
      .compile();
    ...
    // Get the instance of the MockTaskRepository from the testing module
